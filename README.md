...
Atualmente, estou focada no desenvolvimento e banco de dados fortalecendo das minhas habilidades nas seguintes tecnologias:

- **Java**: Estou aprendendo Java para desenvolvimento de aplicações robustas e orientadas a objetos.
- **Python**: Estou aprendendo Python para o desenvolvimento de scripts e aplicações versáteis, com foco em automação, análise de dados e inteligência artificial.
- **SQL**: Estou aprendendo SQL para manipulação e consulta de bancos de dados relacionais, com foco em otimização de consultas e gestão eficiente de dados.
